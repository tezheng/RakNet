...
SWIGINTERN OnFileStruct *new_OnFileStruct_internal(){
...
SWIGINTERN void OnFileStruct_SetFileData(OnFileStruct *self,unsigned char *inByteArray,int numBytes){
		...
		{
			rakFree_Ex(self->fileData, "SwigInterfaceFiles/RakNetCSharpExtends.i", 336);
		}
		//create new with size
		self->fileData=(char*) rakMalloc_Ex(numBytes, "SwigInterfaceFiles/RakNetCSharpExtends.i", 339);
		//copy
		memcpy( self->fileData,inByteArray, numBytes );
	}
SWIGINTERN FileProgressStruct *new_FileProgressStruct_internal(){
...
SWIGINTERN void FileProgressStruct_SetFirstDataChunk(FileProgressStruct *self,unsigned char *inByteArray,int numBytes){
		...
		{
			rakFree_Ex(self->firstDataChunk, "SwigInterfaceFiles/RakNetCSharpExtends.i", 302);
		}
		//create new with size
		self->firstDataChunk=(char*) rakMalloc_Ex(numBytes, "SwigInterfaceFiles/RakNetCSharpExtends.i", 305);
		//copy
...
SWIGINTERN void FileProgressStruct_SetIriDataChunk(FileProgressStruct *self,unsigned char *inByteArray,int numBytes){
		...
		{
			rakFree_Ex(self->iriDataChunk, "SwigInterfaceFiles/RakNetCSharpExtends.i", 314);
		}	
		//create new with size
		self->iriDataChunk=(char*) rakMalloc_Ex(numBytes, "SwigInterfaceFiles/RakNetCSharpExtends.i", 317);
		//copy
...
SWIGINTERN void RakNet_Packet_SetPacketData(RakNet::Packet *self,unsigned char *inByteArray,int numBytes){
		if (self->data!=NULL)
		{
			rakFree_Ex(self->data, "", 6);
		}
		//create new with size
		self->data=(unsigned char*) rakMalloc_Ex(numBytes, "", 9);
		//copy
...
SWIGINTERN bool RakNet_RakPeerInterface_GetConnectionList(RakNet::RakPeerInterface const *self,DataStructures::List< RakNet::SystemAddress > *remoteSystems,unsigned short *numberOfSystems){
		...
		if(remoteSystems!=NULL)
		{
			...
			{
				remoteSystems->Insert(inSys[i],"",55);
			}
		}
		return returnVal;
	}
...
SWIGINTERN void RakNet_FileListNode_SetData(RakNet::FileListNode *self,unsigned char *inByteArray,int numBytes){
		if (self->data!=NULL)
		{
			rakFree_Ex(self->data, "", 10);
		}	
	
		//create new with size
		self->data=(char *) rakMalloc_Ex(numBytes, "", 14);
		//copy
		memcpy( self->data,inByteArray, numBytes );
...
SWIGINTERN bool RakNet_ConnectionGraph2_GetConnectionListForRemoteSystemHelper(RakNet::ConnectionGraph2 *self,RakNet::RakNetGUID remoteSystemGuid,DataStructures::List< RakNet::SystemAddress > *saOut,DataStructures::List< RakNet::RakNetGUID > *guidOut,unsigned int *inOutLength){
		...
		{
			saOut->Insert(tempInSystemAddress[i],"SwigInterfaceFiles/RakNetCSharpExtends.i",473);
			guidOut->Insert(tempInRakNetGUID[i],"SwigInterfaceFiles/RakNetCSharpExtends.i",474);
		}
...
SWIGINTERN void RakNet_ConnectionGraph2_GetParticipantListHelper(RakNet::ConnectionGraph2 *self,DataStructures::List< RakNet::RakNetGUID > *guidOut){
		...
		for (unsigned int i=0; i < participantList.Size(); i++)
			guidOut->Insert(participantList[i],"SwigInterfaceFiles/RakNetCSharpExtends.i",487);
	}
...
SWIGINTERN UnsignedShortPointer *new_UnsignedShortPointer_internal(){
...
SWIGINTERN UnsignedIntPointer *new_UnsignedIntPointer_internal(){
  return new unsigned();
}
...
SWIGEXPORT void * SWIGSTDCALL new_OnFileStruct() {
  ...
  result = (OnFileStruct *)new_OnFileStruct_internal();
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL new_FileProgressStruct() {
  ...
  result = (FileProgressStruct *)new_FileProgressStruct_internal();
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL OpPlus__SWIG_0(void * jarg1, void * jarg2) {
  void * jresult ;
  RakNet::RakString *arg1 = 0 ;
  RakNet::RakString *arg2 = 0 ;
  RakNet::RakString result;
...
SWIGEXPORT void * SWIGSTDCALL OpPlus__SWIG_1(void * jarg1, void * jarg2) {
  void * jresult ;
  RakNet::RakWString *arg1 = 0 ;
  RakNet::RakWString *arg2 = 0 ;
...
SWIGEXPORT void * SWIGSTDCALL new_UnsignedShortPointer() {
  ...
  result = (UnsignedShortPointer *)new_UnsignedShortPointer_internal();
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL new_UnsignedIntPointer() {
  ...
  result = (UnsignedIntPointer *)new_UnsignedIntPointer_internal();
  jresult = (void *)result; 
  return jresult;
}
